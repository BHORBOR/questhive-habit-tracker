;; quest-hive
;; A smart contract for managing quest creation, tracking, and rewards for habit formation
;; This contract enables users to create personalized quests for building habits, track their
;; progress, and earn rewards for consistency, all validated transparently on the Stacks blockchain.
